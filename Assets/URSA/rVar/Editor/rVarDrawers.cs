...
[UnityEditor.CustomPropertyDrawer(typeof(r_int))]
[UnityEditor.CustomPropertyDrawer(typeof(r_string))]
[UnityEditor.CustomPropertyDrawer(typeof(r_Color))]
[UnityEditor.CustomPropertyDrawer(typeof(r_KeyCode))]
public class rVarDrawer : UnityEditor.PropertyDrawer {
    public override void OnGUI(Rect position, UnityEditor.SerializedProperty property, GUIContent label) {
        ...
        if (notifyPropertyChanged) {
            if (EditorGUI.EndChangeCheck()) {
                ...
                var methodInfo = targetProp.GetType().GetMethod("setValue", BindingFlags.IgnoreCase | BindingFlags.InvokeMethod | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
                if (methodInfo != null) {
