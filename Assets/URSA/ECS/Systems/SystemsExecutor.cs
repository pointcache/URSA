...
public class SystemsExecutor : MonoBehaviour {
        ...
        for (int i = 0; i < transforms.Count; i++) {
            objects.Add(
                new ExecutionObject() {
                    ...
                    behavior = transforms[i].gameObject.GetInterface<ISystem>()
                });
        }
    }
    ...
    private class ExecutionObject {
        ...
        public bool IsActiveAndEnabled { get { return gameObject.activeSelf && behavior.Owner.enabled; } }
        public GameObject gameObject;
        public ISystem behavior;
    }
}
