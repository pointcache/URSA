namespace SmartConsole {
    ...
    public class SmartConsole : MonoBehaviour {
        ...
        [System.Serializable]
        public class Options {   // allow to specify font (because we need one imported)
                                 /// <summary>
        ...
        public static void Destroy() {
            ...
            s_masterDictionary = new AutoCompleteDictionary<Command>();
            s_commandHistory = new List<string>();
            s_outputHistory = new List<string>();
            s_lastExceptionCallStack = "(none yet)";
        ...
        static void DestroyChildren(Transform tr) {
